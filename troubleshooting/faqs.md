...
Check out the [DeFi-Robot Simulator](../what-are-the-utilities/bots/defi-robot-contract-simulator/) page for more information about this bot. It's a great utility which extends over all [Live Listing](../what-are-the-utilities/channels/) channels and has an incredible advanced feature only reserved for Tier 3 users.
...
The advanced simulation is run within the [DeFi-Robot Simulator](../what-are-the-utilities/bots/defi-robot-contract-simulator/) bot.
